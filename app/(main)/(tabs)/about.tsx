  ...
  return (
    ...
    >
      ...
      <View style={styles.descriptionContainer}>
        ...
        >
          Vida Laranja is your ultimate guide to Amsterdam&apos;s hidden gems
          and local favorites. From the best fries spots to cozy coffee shops,
          we help you explore the city like a true local.
        </Text>
        ...
        >
          Whether you&apos;re looking for the top restaurants, cultural events,
          or unique experiences, our curated recommendations will make your
